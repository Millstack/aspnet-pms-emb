...
<body>
    <form id="form1" runat="server">
        ...
        <div class="card no-b  no-r">
            <telerik:RadGrid ID="Radgrid1" runat="server" Skin="Office2007" CssClass="borderLessDialog" AllowPaging="true" AllowSorting="true" AllowFilteringByColumn="true"
                ...
                <MasterTableView CommandItemDisplay="TopAndBottom" ShowGroupFooter="true" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                    ClientDataKeyNames="ProjectCode">
                    <CommandItemSettings ShowExportToExcelButton="true" ShowAddNewRecordButton="true" ShowExportToPdfButton="true" />
                    <Columns>
                        <telerik:GridBoundColumn DataField="ProjMasterCaty" HeaderText="ProjMasterCaty" SortExpression="EmployeeID" HeaderStyle-Font-Bold="true" FooterStyle-Height="10px"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ProjectName" HeaderText="ProjectName" SortExpression="EmployeeFirstName" HeaderStyle-Font-Bold="true" FooterStyle-Height="10px"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ProjectCode" HeaderText="ProjectCode" SortExpression="EmployeeLastName" HeaderStyle-Font-Bold="true" FooterStyle-Height="10px"></telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="ProjMastDistrict" HeaderText="ProjMastDistrict" SortExpression="EmployeeSalary" HeaderStyle-Font-Bold="true" FooterStyle-Height="10px"></telerik:GridBoundColumn>
                ...
                <ExportSettings FileName="summary_SystemUsers" OpenInNewWindow="True" ExportOnlyData="True" Excel-Format="ExcelML">
                    ...
                    <Pdf AllowCopy="True" Author="The Company" BorderStyle="Thin" PageTitle="Access Review for System" ForceTextWrap="True" PageBottomMargin="0.5in" PageLeftMargin="0.5in" PageRightMargin="0.5in" PageTopMargin="0.5in" PageHeight="8.5in" PageWidth="11in">
